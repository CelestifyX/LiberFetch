...
install:
	@mkdir -p $(PREFIX)/local/share/lfetch{,/colors,/main_module,/system_info,/window_manager,/functions}
	...
	@install -Dm755 functions/functions.py           $(DESTDIR)$(PREFIX)/local/share/lfetch/functions/functions.py
